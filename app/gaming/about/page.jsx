...
const page = () => {
  ...
  return (
    <div className='h-screen w-screen text-[1.2rem] max-lg:text-[1rem] max-sm:text-[0.7rem] text-amber-50 flex justify-center items-center text-center overflow-hidden pl-20 pr-20  box-border z-10'>
